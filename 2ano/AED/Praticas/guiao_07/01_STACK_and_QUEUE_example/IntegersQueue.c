...
//! Quando passamos um ponteiro simples (Queue*) para uma função, essa função 
//! recebe uma cópia do ponteiro e só pode alterar o conteúdo apontado, mas não 
//! pode modificar o ponteiro em si.
