...
def adicionarContacto():
    nome_novo = input("Qual é o nome do contacto novo? ")
    numero_novo = input("Qual é o numero do contacto novo? ")
    
    while not numero_novo.isnumeric():
        numero_novo = input("Por favor insere um número válido")
