...
-- Equation(s):
-- \system_core|decOut_n~9_combout\ = (\SW[3]~input_o\ & (\SW[0]~input_o\ & (\SW[1]~input_o\ & !\SW[2]~input_o\))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (\SW[0]~input_o\ $ (\SW[1]~input_o\))))
...
-- Equation(s):
-- \system_core|decOut_n~11_combout\ = (!\SW[3]~input_o\ & (!\SW[0]~input_o\ & (\SW[1]~input_o\ & !\SW[2]~input_o\)))
...
-- Equation(s):
-- \system_core|decOut_n~15_combout\ = (\SW[0]~input_o\ & (\SW[3]~input_o\ $ (((\SW[1]~input_o\) # (!\SW[2]~input_o\))))) # (!\SW[0]~input_o\ & (!\SW[3]~input_o\ & (\SW[1]~input_o\ & !\SW[2]~input_o\)))
